    ...
    return (
        <main className={styles.main}>
            ...
            <div className={styles.right}>
                ...
                <span className={styles.text}>Faça login na sua conta para acessar <br/> suas senhas com segurança.</span>
                ...
                <p className={styles.fogot}>Esqueci minha senha, <span onClick={() => router.push('#')}>clique aqui</span></p>
